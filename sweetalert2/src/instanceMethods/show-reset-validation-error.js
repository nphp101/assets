...
export function showValidationMessage(error) {
  ...
  domCache.validationMessage.style.marginLeft = `-${popupComputedStyle.getPropertyValue(
    "padding-left"
  )}`;
  domCache.validationMessage.style.marginRight = `-${popupComputedStyle.getPropertyValue(
    "padding-right"
  )}`;
