...
QUnit.test("update customClass", (assert) => {
  ...
  assert.notOk(
    Swal.getConfirmButton().classList.contains("confirm-button-class")
  );
  assert.notOk(
    Swal.getCancelButton().classList.contains("cancel-button-class")
  );
  ...
  assert.ok(
    Swal.getConfirmButton().classList.contains("confirm-button-class-NEW")
  );
  assert.ok(
    Swal.getCancelButton().classList.contains("cancel-button-class-NEW")
  );
...
QUnit.test(
  "update() method should throw a warning when attempting to update the closing popup",
  (assert) => {
