(function (assert) {
    ...
    const equalNodePosition = function (
        assert,
        node,
        expectedParent,
    ...
    const equalNodePositionWrapped = function (
        assert,
        node,
        anchor,
        expectedParent,
    ...
    QUnit.test("insertBefore: no element when wrapped in <a>", function (
        assert
    ) {
    ...
    QUnit.test("insertBefore: first element when wrapped in <a>", function (
        assert
    ) {
        const x = paper.rect();
        const el = paper.rect().attr("href", url),
    ...
    QUnit.test("insertBefore: middle element when wrapped in <a>", function (
        assert
    ) {
        const x = paper.rect();
        const y = paper.rect();
    ...
    QUnit.test("insertAfter: no element when wrapped in <a>", function (
        assert
    ) {
        const el = paper.rect().attr("href", url),
            anchor = el.node.parentNode;
    ...
    QUnit.test("insertAfter: last element when wrapped in <a>", function (
        assert
    ) {
        const x = paper.rect();
        const el = paper.rect().attr("href", url),
    ...
    QUnit.test("insertAfter: middle element when wrapped in <a>", function (
        assert
    ) {
        const x = paper.rect();
        const y = paper.rect();
