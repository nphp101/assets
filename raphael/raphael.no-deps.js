  ...
  \*****************************/
    ...
    \*/
                        R.parsePathString = function (pathString) {
                            ...
                            if (!data.length) {
                                Str(pathString).replace(pathCommand, function (
                                    a,
                                    b,
                                    c
                                ) {
    ...
    \*/
                        R.parseTransformString = cacher(
                            function (TString) {
                                ...
                                if (!data.length) {
                                    Str(TString).replace(tCommand, function (
                                        a,
                                        b,
                                        c
                                    ) {
    ...
    \*/
        ...
        \*/
            ...
            \*/
                            ...
                            equaliseTransform = (R._equaliseTransform = function (
                                t1,
                                t2
                            ) {
    ...
    \*/
                        setproto.splice = function (index, count, insertion) {
                            ...
                            i = this.items.length = this.length -=
                                count - arglen;
                            while (this[i]) {
                                delete this[i++];
                            }
                            ...
                            addArrow = function (o, value, isEnd) {
                                if (o.type == "path") {
                                    ...
                                    if (type != "none") {
                                        ...
                                        var marker = R._g.doc.getElementById(
                                                markerId
                                            ),
                                            use;
                                        if (!marker) {
                                            ...
                                            use = marker.getElementsByTagName(
                                                "use"
                                            )[0];
                                        }
                                        $(use, attr);
                                    ...
                                    for (attr in markerCounter)
                                        if (
                                            ...
                                            var item = R._g.doc.getElementById(
                                                attr
                                            );
                                            item &&
                                    ...
                                    if (params[has](att)) {
                                        ...
                                        switch (att) {
                                            case "blur":
                                                ...
                                                break;
                                            case "title":
                                                var title = node.getElementsByTagName(
                                                    "title"
                                                );
                                                ...
                                                if (
                                                    ...
                                                    title = $("title");
                                                    var val = R._g.doc.createTextNode(
                                                        value
                                                    );
                                            ...
                                            case "fill":
                                                ...
                                                if (!clr.error) {
                                                    ...
                                                    if (
                                                        ...
                                                        if (gradient) {
                                                            var stops = gradient.getElementsByTagName(
                                                                "stop"
                                                            );
                                                            $(
                                                                stops[
                                            ...
                                            case "fill-opacity":
                                                if (attrs.gradient) {
                                                    ...
                                                    if (gradient) {
                                                        stops = gradient.getElementsByTagName(
                                                            "stop"
                                                        );
                                                        $(
                                                            stops[
    ...
    \*/
                        ...
                        elproto._getBBox = function () {
                            ...
                            if (this.paper.canvas.parentElement) {
                                containerStyle = this.paper.canvas.parentElement
                                    .style;
                            } //IE10+ can't find parentElement
                            else if (this.paper.canvas.parentNode) {
                                containerStyle = this.paper.canvas.parentNode
                                    .style;
                            }
                            ...
                            if (value == null && R.is(name, "string")) {
                                ...
                                for (
                                    ...
                                    if (name in this.attrs) {
                                        ...
                                        out[name] = this.paper.customAttributes[
                                            name
                                        ].def;
                                    } else {
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    (__WEBPACK_AMD_DEFINE_RESULT__ = function (R) {
                        ...
                        var has = "hasOwnProperty",
                            ...
                            setCoords = function (p, sx, sy, dx, dy, deg) {
                                ...
                                if (fillpos || _.fillsize) {
                                    var fill = o.getElementsByTagName(
                                        fillString
                                    );
                                    fill = fill && fill[0];
                                    o.removeChild(fill);
                        ...
                        var addArrow = function (o, value, isEnd) {
                                ...
                                var stroke = o.node.getElementsByTagName(
                                    "stroke"
                                )[0];
                            ...
                            setFillAndStroke = function (o, params) {
                                ...
                                if (
                                    ...
                                    var fill = node.getElementsByTagName(
                                            fillString
                                        ),
                                        newfill = false;
                                    fill = fill && fill[0];
                                    !fill &&
                                        (newfill = fill = createNode(
                                            fillString
                                        ));
                        ...
                        R._engine.create = function () {
                            ...
                            var res = new R._Paper(),
                                c = (res.canvas = R._g.doc.createElement(
                                    "div"
                                )),
                                cs = c.style;
                            x = x || 0;
