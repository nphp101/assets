...
!(function (a, b) {
  ...
  function f(a, c, d) {
    ...
    return (
      (f = d.cache[a]
        ...
        : d.createElem(a)),
      !f.canHaveChildren || s.test(a) || f.tagUrn ? f : d.frag.appendChild(f)
    );
  }
  function g(a, c) {
  ...
  function j(a) {
    for (
      ...
      (b = c[e]), f.test(b.nodeName) && g.push(b.applyElement(k(b)));
    return g;
  }
  function k(a) {
    for (
      var b,
        c = a.attributes,
        d = c.length,
        e = a.ownerDocument.createElement(z + ":" + a.nodeName);
      d--;
  ...
  function n(a) {
    ...
    var d,
      ...
      h = a.namespaces,
      i = a.parentWindow;
    return !A || a.printShived
      ? a
      : ("undefined" == typeof h[z] && h.add(z),
        i.attachEvent("onbeforeprint", function () {
          b();
          for (
            var e, g, h, i = a.styleSheets, k = [], m = i.length, n = Array(m);
            m--;
