...
invoked with one argument: _(value)_.
...
equal elements. The iteratees are invoked with one argument: _(value)_.
...
up to four arguments; _(value [, index|key, object, stack])_.
...
six arguments: _(objValue, othValue [, index|key, object, other, stack])_.
...
arguments: _(objValue, srcValue, index|key, object, source)_.
...
of `Object`. _(e.g. arrays, functions, objects, regexes, `new Number(0)`, and `new String('')`)_
...
invoked for each element in `array` to generate the criterion by which
the value is ranked. The iteratee is invoked with one argument: _(value)_.
...
The iteratee is invoked with one argument: _(value)_.
...
is invoked with five arguments: _(objValue, srcValue, key, object, source)_.
<br>
<br>
**Note:** This method mutates `object`.
...
with three arguments: _(value, key, object)_. Iteratee functions may exit
...
arguments: _(value, key, object)_. Iteratee functions may exit iteration
...
with three arguments: _(value, key, object)_.
...
truthy for. The predicate is invoked with two arguments: _(value, key)_.
...
with three arguments: _(nsValue, key, nsObject)_.
<br>
<br>
**Note:** This method mutates `object`.
...
iteratee is invoked with four arguments: _(accumulator, value, key, object)_.
Iteratee functions may exit iteration early by explicitly returning `false`.
...
is invoked with one argument: _(value)_.
<br>
<br>
**Note:** This method mutates `object`.
...
is invoked with one argument; _(value)_. The purpose of this method is to
...
_*.prototype.toJSON, *.prototype.valueOf_
...
_(under "semi-related fun fact")_ for more details.
<br>
<br>
...
Creates an array of numbers _(positive and/or negative)_ progressing from
...
each invocation. The iteratee is invoked with one argument; _(index)_.
...
embedded Ruby _(ERB)_ as well as ES2015 template strings. Change the
