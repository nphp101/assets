(function () {
  ...
  var mapCaches = (function () {
    ...
    (_.isMatchWith || lodashStable.isMatchWith)(
      { a: 1 },
      { a: 1 },
      function () {
  ...
  lodashStable.attempt(function () {
    ...
    if (isModularize && !(amd || isNpm)) {
      lodashStable.each(
        ...
        function (funcName) {
          _["_" + funcName] = interopRequire(
            path.join(basePath, "_" + funcName)
          );
        }
      );
    }
  ...
  (function () {
    ...
    lodashStable.forOwn(createCaches(pairs), function (cache, kind) {
      ...
      QUnit.test("should implement a `Map` interface for " + kind, function (
        ...
        assert.strictEqual(
          cache.size,
          isLarge ? LARGE_ARRAY_SIZE : keys.length
        );
    ...
    lodashStable.forOwn(createCaches(), function (cache, kind) {
      QUnit.test("should support changing values of " + kind, function (
        assert
      ) {
        assert.expect(10);
  ...
  (function () {
    ...
    QUnit.test(
      ...
      function (assert) {
        ...
        if (!isNpm) {
          assert.ok(
            _(lodashStable.constant("x")).chain().attempt() instanceof _
          );
        } else {
          skipAssert(assert);
        }
  ...
  (function () {
    ...
    QUnit.test("should return a wrapped value when chaining", function (
      assert
    ) {
      assert.expect(2);
  ...
  (function () {
    ...
    QUnit.test("should handle acronyms", function (assert) {
      ...
      lodashStable.each(["XMLHttpRequest", "XmlHTTPRequest"], function (
        string
      ) {
    ...
    lodashStable.each(["clone", "cloneDeep"], function (methodName) {
      ...
      QUnit.test(
        ...
        function (assert) {
          ...
          var values = lodashStable.map([false, true, 1, "a"], function (
            value
          ) {
  ...
  (function () {
    ...
    QUnit.test("should work with an object for `collection`", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    QUnit.test("should convert Latin Unicode letters to basic Latin", function (
      assert
    ) {
      assert.expect(1);
    ...
    QUnit.test("should not deburr Latin mathematical operators", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should not indirectly merge `Object` properties", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should provide correct `iteratee` arguments", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should work with `position` >= `length`", function (assert) {
      ...
      lodashStable.each([3, 5, MAX_SAFE_INTEGER, Infinity], function (
        position
      ) {
  ...
  (function () {
    ...
    lodashStable.each(["`", "/"], function (chr) {
      QUnit.test('should not escape the "' + chr + '" character', function (
        assert
      ) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should coerce `start` and `end` to integers", function (
      assert
    ) {
      assert.expect(1);
  ...
  lodashStable.each(["flatMap", "flatMapDeep", "flatMapDepth"], function (
    ...
    QUnit.test(
      "`_." + methodName + "` should accept a falsey `collection`",
      function (assert) {
        assert.expect(1);
      ...
      function (assert) {
        ...
        lodashStable.times(2, function (index) {
          var filter1 = _.filter,
            ...
            filter3 =
              ((_.filter = index ? filter2 : filter1), filter2(predicate));
    ...
    lodashStable.each(
      ...
      function (methodName) {
        ...
        QUnit.test(
          "`_." +
            methodName +
            "` should not iterate custom properties on arrays",
          function (assert) {
            assert.expect(1);
  ...
  lodashStable.each(["has", "hasIn"], function (methodName) {
    ...
    QUnit.test(
      "`_." +
        methodName +
        "` should return `true` for indexes of sparse values with deep paths",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should return `undefined` when querying empty arrays",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should return `false` for empty collections", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should work with a floating point `n` value", function (
      assert
    ) {
      assert.expect(4);
  ...
  lodashStable.each(
    ...
    function (methodName) {
      ...
      QUnit.test("`_." + methodName + "` should match `NaN`", function (
        assert
      ) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should return `false` for non array buffers", function (
      assert
    ) {
      assert.expect(13);
  ...
  (function () {
    ...
    QUnit.test("should compare array buffers", function (assert) {
      ...
      if (ArrayBuffer) {
        ...
        assert.strictEqual(
          _.isEqual(buffer, new Uint8Array([255]).buffer),
          true
        );
  ...
  (function () {
    ...
    QUnit.test("should return `false` for non error objects", function (
      assert
    ) {
      assert.expect(12);
  ...
  (function () {
    ...
    QUnit.test("should return `false` for non-finite values", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should return `true` for the `Proxy` constructor", function (
      assert
    ) {
      assert.expect(1);
    ...
    QUnit.test(
      ...
      function (assert) {
        ...
        if (!amd && _._baseEach) {
          ...
          var baseIsNative = interopRequire(
            path.join(basePath, "_baseIsNative")
          );
  ...
  (function () {
    ...
    QUnit.test("should return `false` for non `null` values", function (
      assert
    ) {
      assert.expect(13);
  ...
  (function () {
    ...
    QUnit.test("should work with numbers from another realm", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should work with objects from another realm", function (
      assert
    ) {
      assert.expect(8);
  ...
  (function () {
    ...
    QUnit.test("should return `false` for non-Object objects", function (
      assert
    ) {
      assert.expect(3);
  ...
  (function () {
    ...
    QUnit.test("should work with regexes from another realm", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should work with strings from another realm", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should work with symbols from another realm", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    QUnit.test("should return `true` for `undefined` values", function (
      assert
    ) {
      assert.expect(2);
  ...
  (function () {
    QUnit.test("should return `false` for subclassed values", function (
      assert
    ) {
      assert.expect(7);
  ...
  (function () {
    ...
    QUnit.test("`_.find` should use `_.iteratee` internally", function (
      assert
    ) {
      assert.expect(1);
    ...
    QUnit.test(
      "`_.findLastIndex` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test("`_.some` should use `_.iteratee` internally", function (
      assert
    ) {
      assert.expect(1);
    ...
    QUnit.test(
      "`_.sortedIndexBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should return `false` if `value` >= `other`", function (
      assert
    ) {
      assert.expect(4);
  ...
  lodashStable.each(
    ...
    function (methodName) {
      ...
      QUnit.test(
        "`_." + methodName + "` should accept a falsey `array`",
        function (assert) {
          assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should map keys in `object` to a new object", function (
      assert
    ) {
      assert.expect(1);
  ...
  lodashStable.each(["mapKeys", "mapValues"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should accept a falsey `object`",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should return `false` if parts of `path` are missing",
      function (assert) {
        assert.expect(4);
    ...
    QUnit.test(
      "should not change behavior if `srcValue` is modified",
      function (assert) {
        assert.expect(9);
  ...
  (function () {
    ...
    QUnit.test("should merge onto non-plain `object` values", function (
      assert
    ) {
      assert.expect(2);
  ...
  (function () {
    ...
    QUnit.test("should provide `stack` to `customizer`", function (assert) {
      ...
      _.each(actual, function (a) {
        assert.ok(
          isNpm ? a.constructor.name == "Stack" : a instanceof mapCaches.Stack
        );
      });
    });
    ...
    QUnit.test(
      ...
      function (assert) {
        ...
        var actual = _.mergeWith({ a: 0 }, { a: { b: ["c"] } }, function (
          a,
          b
        ) {
          return lodashStable.isArray(a) ? a.concat(b) : undefined;
  ...
  lodashStable.each(["max", "maxBy", "min", "minBy"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should work with Date objects",
      function (assert) {
        assert.expect(1);
  ...
  lodashStable.each(["maxBy", "minBy"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should work with an `iteratee`",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should work with `arguments` object `paths`", function (
      assert
    ) {
      assert.expect(1);
  ...
  lodashStable.each(["omit", "omitBy"], function (methodName) {
    ...
    QUnit.test("`_." + methodName + "` should include symbols", function (
      assert
    ) {
      assert.expect(3);
  ...
  (function () {
    ...
    QUnit.test("should parse strings with leading whitespace", function (
      assert
    ) {
      assert.expect(2);
  ...
  (function () {
    ...
    QUnit.test("should not treat keys with dots as deep paths", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should reorder arguments provided to `func`", function (
      assert
    ) {
      assert.expect(1);
    ...
    QUnit.test("should use `undefined` for non-index values", function (
      assert
    ) {
      assert.expect(1);
  ...
  lodashStable.each(["ceil", "floor", "round"], function (methodName) {
    ...
    QUnit.test(
      "`_." +
        methodName +
        "` should return `Infinity` given `Infinity` regardless of `precision`",
      function (assert) {
        assert.expect(6);
    ...
    QUnit.test(
      "`_." +
        methodName +
        "` should return `NaN` given `NaN` regardless of `precision`",
      function (assert) {
        assert.expect(6);
  ...
  (function () {
    ...
    QUnit.test(
      "should return an empty array when `n` < `1` or `NaN`",
      function (assert) {
        assert.expect(3);
  ...
  (function () {
    ...
    QUnit.test("should work in a lazy sequence", function (assert) {
      ...
      if (!isNpm) {
        ...
        lodashStable.each(["map", "filter"], function (methodName) {
          assert.deepEqual(
            wrapped[methodName]().slice(0, -1).value(),
            array.slice(0, -1)
          );
          assert.deepEqual(
            wrapped[methodName]().slice(1).value(),
            array.slice(1)
          );
          assert.deepEqual(
            wrapped[methodName]().slice(1, 3).value(),
            array.slice(1, 3)
          );
          assert.deepEqual(
            wrapped[methodName]().slice(-1).value(),
          ...
          assert.deepEqual(
            wrapped[methodName]().slice(length).value(),
            array.slice(length)
          );
          assert.deepEqual(
            wrapped[methodName]().slice(3, 2).value(),
            array.slice(3, 2)
          );
          assert.deepEqual(
          ...
          assert.deepEqual(
            wrapped[methodName]().slice(0, null).value(),
            array.slice(0, null)
          );
          ...
          assert.deepEqual(
            wrapped[methodName]().slice(null).value(),
            array.slice(null)
          );
          ...
          assert.deepEqual(
            wrapped[methodName]().slice(NaN, "1").value(),
            array.slice(NaN, "1")
          );

          assert.deepEqual(
            wrapped[methodName]().slice(0.1, 1.1).value(),
            array.slice(0.1, 1.1)
          );
          assert.deepEqual(
            wrapped[methodName]().slice("0", 1).value(),
          ...
          assert.deepEqual(
            wrapped[methodName]().slice(1, NaN).value(),
            array.slice(1, NaN)
          );
        });
      } else {
  ...
  (function () {
    ...
    QUnit.test("should return an empty array when `n` < `1`", function (
      assert
    ) {
      assert.expect(3);
  ...
  (function () {
    QUnit.test("should intercept and return the given value", function (
      assert
    ) {
      assert.expect(2);
  ...
  (function () {
    QUnit.test('should escape values in "escape" delimiters', function (
      assert
    ) {
      assert.expect(1);
    ...
    QUnit.test("should not include sourceURLs in the source", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should preserve the sign of `0` in an array", function (
      assert
    ) {
      assert.expect(1);
  ...
  (function () {
    ...
    lodashStable.each(["&#96;", "&#x2F;"], function (entity) {
      QUnit.test('should not unescape the "' + entity + '" entity', function (
        assert
      ) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should follow `path` over non-plain objects", function (
      assert
    ) {
      assert.expect(8);
      ...
      lodashStable.each(["a.replace.b", ["a", "replace", "b"]], function (
        path
      ) {
  ...
  (function () {
    QUnit.test("should match words containing Latin Unicode letters", function (
      assert
    ) {
      assert.expect(1);
    ...
    QUnit.test("should not treat contractions as separate words", function (
      assert
    ) {
      assert.expect(4);
    ...
    QUnit.test("should not treat ordinal numbers as separate words", function (
      assert
    ) {
      assert.expect(2);
    ...
    QUnit.test(
      ...
      function (assert) {
        ...
        if (!isNpm) {
          ...
          var actual = lodashStable.map(["head", "last"], function (
            methodName
          ) {
  ...
  lodashStable.each([false, true], function (implicit) {
    ...
    QUnit.test("should work in a lazy sequence " + chainType, function (
      assert
    ) {
      assert.expect(3);
